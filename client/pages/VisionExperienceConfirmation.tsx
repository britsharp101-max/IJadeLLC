      ...
      <section className="bg-gradient-to-b from-white to-gray-50 py-32 px-4">
        <div className="max-w-2xl mx-auto flex flex-col items-center text-center">
          ...
          <p className="text-xl text-jade font-inter font-semibold mb-6">
            Your Vision Experience Request
          </p>

          {/* Message */}
          <p className="text-base text-gray-600 font-inter leading-relaxed mb-12 max-w-lg">
            We appreciate your interest in the Vision Experience. Our team has received your submission and will be in contact with you shortly at the email and phone number you provided. Get ready to create your vision and achieve your dream!
          </p>
