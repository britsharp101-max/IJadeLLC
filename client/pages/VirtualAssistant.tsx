...
export default function VirtualAssistant() {
  ...
  return (
    <Layout>
      {/* Page banner */}
      <div className="bg-jade py-6 text-center">
        <h1 className="text-white text-4xl md:text-5xl font-bold font-inter">Virtual Assistant Services</h1>
      </div>
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-5xl font-bold font-inter text-black mb-8 leading-tight">
                Create Your Vision<br />
                Achieve Your Dream!
              </h2>
              <p className="text-lg font-normal font-inter text-black leading-relaxed mb-10">
              ...
              <Link
                ...
                className="inline-block px-10 py-4 bg-jade text-white font-bold font-inter text-lg rounded-lg hover:bg-jade/90 transition-colors"
              >
                Get Connected
              </Link>
            </div>
